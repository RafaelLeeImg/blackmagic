...
/* This file implements the platform specific functions for the Saruman
 * implementation.
 */
#ifndef __PLATFORM_H
#define __PLATFORM_H
...
#define BOARD_IDENT             "Saruman"
#define BOARD_IDENT_DFU	        "Saruman (Upgrade)"
#define BOARD_IDENT_UPD	        "Saruman (DFU Upgrade)"
#define DFU_IDENT               "Saruman Firmware Upgrade"
