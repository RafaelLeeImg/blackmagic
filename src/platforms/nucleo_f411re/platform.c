...
const struct rcc_clock_scale rcc_hse_24mhz_3v3[RCC_CLOCK_3V3_END] = {
	{ /* 96MHz */
		...
		// PM0081
		// Number of wait states according to CPU clock (HCLK) frequency (VOS = ‘1’)
		// 1.8 Flash interface registers
		// 1.8.1 Flash access control register (FLASH_ACR), DCEN, ICEN
